				...
				<nav
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800 hansans"
							style="padding-top: 28px;">조제 진행 목록: 제조완료</h1>
					</div>
				</nav>
						...
						<div class="col-xl-12">
							<div class="card shadow mb-4">
								...
								<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
									...
									<h6 class="m-0 font-weight-bold text-primary">제조완료</h6>
							    ...
							    <tbody>
							        <c:forEach items="${dispenseComplete}" var="dto">
							            <tr>
							...
							<div style="margin-top: 10px; text-align: center;">
							    <button id="finishBtn">수령 완료</button>						
							</div>
			...
			$(document).ready(function() {
			    $('#finishBtn').on('click', function() {
			       ...
			       // alert("선택된 항목 수: " + selectedItems.length);
			        const confirmApproval = confirm("선택한 처방내역을 제조완료하시겠습니까?");
			       ...
			       // console.log(dispenseIds);	//여기까지 찍힘
			        ...
			        if (confirmApproval) {
			            ...
			            $.ajax({
			                type: 'PUT',
			                url: '/apa/api/pharmacy/' + pharmacyId + '/dispensecomplete',
			                dataType: 'text',
