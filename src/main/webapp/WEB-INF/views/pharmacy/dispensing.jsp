				...
				<nav
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800 hansans"
							style="padding-top: 28px;">조제 진행 목록: 제조중</h1>
					</div>
				</nav>
						...
						<div class="col-xl-12">
							<div class="card shadow mb-4">
								...
								<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
									...
									<h6 class="m-0 font-weight-bold text-primary">제조중</h6>
							    ...
							    <tbody>
							        <c:forEach items="${dispensing}" var="dto">
							            <tr>
							...
							<div style="margin-top: 10px; text-align: center;">
							    <button id="finishBtn">제조 완료</button>						
							</div>
	    ...
	    $('#finishBtn').on('click', function() {
	       ...
	       // console.log(dispenseIds);	//여기까지 찍힘
	        ...
	        if (confirmApproval) {
	            ...
	            $.ajax({
	                type: 'PUT',
	                url: '/apa/api/pharmacy/' + pharmacyId + '/dispensing',
	                dataType: 'text',
